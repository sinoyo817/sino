...
import { MasterContactCategoryFilterParamType } from "../types";
...
const Search = (props: SearchPropsType) => {
    ...
    const { register, reset } =
        useFormContext<MasterContactCategoryFilterParamType>();
    ...
    return (
        <BaseSearchForm<MasterContactCategoryFilterParamType>
