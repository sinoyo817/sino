...
import { MasterEventCategoryFilterParamType } from "../types";
...
const Search = (props: SearchPropsType) => {
    ...
    const { register, reset } =
        useFormContext<MasterEventCategoryFilterParamType>();
    ...
    return (
        <BaseSearchForm<MasterEventCategoryFilterParamType>
