...
/**
 * MasterContactCategories Controller
 *
 * @method \App\Model\Entity\MasterContactCategory[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class MasterContactCategoriesController extends AppController
{
    protected $defaultTable = 'MasterContactCategories';
