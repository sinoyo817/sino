...
/**
 * MasterAreas Controller
 *
 * @property \App\Model\Table\MasterAreasTable $MasterAreas
 * @method \App\Model\Entity\MasterArea[]|\Cake\Datasource\ResultSetInterface paginate($object = null, array $settings = [])
 */
class MasterAreasController extends AppController
{
    protected $defaultTable = 'MasterAreas';
