...
if (file_exists(CONFIG . 'auth.json')) {
    Configure::load('auth', 'json', false);
}

if (file_exists(CONFIG . 'settings_default.php')) {
    Configure::load('settings_default', 'default', false);
}

if (file_exists(CONFIG . 'settings.json')) {
    Configure::load('settings', 'json');
}



// https://github.com/josbeir/cakephp-filesystem
// if (file_exists(CONFIG . 'filesystem.php')) {
//     Configure::load('filesystem', 'default');
// }
