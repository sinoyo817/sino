...
class SamplesTranslations extends AbstractMigration
{
    /**
     * Change Method.
     *
    ...
    {
        $this->table('samples_translations', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
        ...
        $this->table('samples_translations_private', ['id' => false, 'primary_key' => ['id']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
