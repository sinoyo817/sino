...
class TopicsTranslations extends AbstractMigration
{
    /**
     * Up Method.
     *
    ...
    public function up()
    {
        $this->table('topics_translations', ['id' => false, 'primary_key' => ['id', 'locale']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
        ...
        $this->table('topics_private_translations', ['id' => false, 'primary_key' => ['id', 'locale']])
            ->addColumn('id', 'uuid', [
                'default' => null,
                'limit' => null,
                'null' => false,
    ...
    {
        $this->table('topics_translations')->drop()->save();
        $this->table('topics_private_translations')->drop()->save();
    }
}
